...
Z(z[6])
Z([[4],[[5],[[4],[[5],[[5],[1,'tap']],[[4],[[5],[[4],[[5],[[5],[1,'notifyBLECharacteristicValueChange']],[[4],[[5],[1,'$event']]]]]]]]]]])
Z([[6],[[7],[3,'disabled']],[1,7]])
Z(z[9])
Z([3,'使能Notification'])
Z(z[6])
Z([[4],[[5],[[4],[[5],[[5],[1,'tap']],[[4],[[5],[[4],[[5],[[5],[1,'readBLECharacteristicValue']],[[4],[[5],[1,'$event']]]]]]]]]]])
Z(z[62])
Z(z[9])
Z([3,'读取数据'])
Z([[7],[3,'notificationData']])
Z([3,'list-name'])
Z([a,[[2,'+'],[[2,'+'],[1,'最新的值:'],[[2,'||'],[[7],[3,'notificationData']],[1,'还没有最新值']]],[1,'']]])
Z(z[70])
Z(z[6])
Z([[4],[[5],[[4],[[5],[[5],[1,'tap']],[[4],[[5],[[4],[[5],[[5],[1,'showChart']],[[4],[[5],[1,'$event']]]]]]]]]]])
Z([[7],[3,'chartMaskShow']])
Z(z[9])
Z([3,'显示波形图'])
Z(z[6])
...
Z(z[6])
Z(z[92])
Z([[4],[[5],[[5],[[4],[[5],[[5],[1,'touchmove']],[[4],[[5],[[4],[[5],[[5],[1,'chartMoveHandle']],[[4],[[5],[1,'$event']]]]]]]]]],[[4],[[5],[[5],[1,'tap']],[[4],[[5],[[4],[[5],[[5],[1,'chartMaskClose']],[[4],[[5],[1,'$event']]]]]]]]]]])
Z([3,'qiun-columns'])
Z([3,'qiun-charts'])
Z(z[6])
Z([3,'canvasLineA'])
...
var x=['./pages/bluetooth/bluetooth.wxml'];d_[x[0]]={}
var m0=function(e,s,r,gg){
var z=gz$gwx_1()
var oB=_n('view')
var fE=_mz(z,'page-head',['bind:__l',0,'title',1,'vueId',1],[],e,s,gg)
_(oB,fE)
var cF=_n('view')
...
var oP=_mz(z,'button',['bindtap',6,'data-event-opts',1,'disabled',2,'type',3],[],e,s,gg)
...
var cT=_mz(z,'button',['bindtap',13,'data-event-opts',1,'disabled',2,'loading',3,'type',4],[],e,s,gg)
var hU=_oz(z,18,e,s,gg)
_(cT,hU)
_(cI,cT)
var oV=_mz(z,'button',['bindtap',19,'data-event-opts',1,'disabled',2,'type',3],[],e,s,gg)
var cW=_oz(z,23,e,s,gg)
_(oV,cW)
_(cI,oV)
var oX=_mz(z,'button',['bindtap',24,'data-event-opts',1,'disabled',2,'loading',3,'type',4],[],e,s,gg)
var lY=_oz(z,29,e,s,gg)
_(oX,lY)
_(cI,oX)
var lK=_v()
_(cI,lK)
if(_oz(z,30,e,s,gg)){lK.wxVkey=1
var aZ=_n('view')
var t1=_oz(z,31,e,s,gg)
_(aZ,t1)
_(lK,aZ)
}
var e2=_mz(z,'button',['bindtap',32,'data-event-opts',1,'disabled',2,'type',3],[],e,s,gg)
var b3=_oz(z,36,e,s,gg)
_(e2,b3)
_(cI,e2)
var o4=_mz(z,'button',['bindtap',37,'data-event-opts',1,'disabled',2,'type',3],[],e,s,gg)
...
var c8=_mz(z,'button',['bindtap',44,'data-event-opts',1,'disabled',2,'type',3],[],e,s,gg)
var h9=_oz(z,48,e,s,gg)
_(c8,h9)
_(cI,c8)
var tM=_v()
_(cI,tM)
if(_oz(z,49,e,s,gg)){tM.wxVkey=1
var o0=_n('view')
var cAB=_n('view')
...
var fKB=_mz(z,'button',['bindtap',60,'data-event-opts',1,'disabled',2,'type',3],[],e,s,gg)
var cLB=_oz(z,64,e,s,gg)
_(fKB,cLB)
_(cI,fKB)
var hMB=_mz(z,'button',['bindtap',65,'data-event-opts',1,'disabled',2,'type',3],[],e,s,gg)
...
var bO=_v()
_(cI,bO)
if(_oz(z,73,e,s,gg)){bO.wxVkey=1
var aRB=_mz(z,'button',['bindtap',74,'data-event-opts',1,'disabled',2,'type',3],[],e,s,gg)
var tSB=_oz(z,78,e,s,gg)
_(aRB,tSB)
_(bO,aRB)
}
var eTB=_mz(z,'button',['bindtap',79,'data-event-opts',1,'disabled',2,'type',3],[],e,s,gg)
var bUB=_oz(z,83,e,s,gg)
_(eTB,bUB)
_(cI,eTB)
var oVB=_mz(z,'button',['bindtap',84,'data-event-opts',1,'disabled',2,'type',3],[],e,s,gg)
...
var oXB=_mz(z,'view',['bindtap',90,'catchtouchmove',1,'class',2,'data-event-opts',3],[],e,s,gg)
var fYB=_mz(z,'scroll-view',['scrollY',-1,'catchtap',94,'catchtouchmove',1,'class',2,'data-event-opts',3],[],e,s,gg)
var cZB=_n('view')
...
var e8B=_mz(z,'view',['bindtap',104,'class',1,'data-event-opts',2],[],l5B,o4B,gg)
var b9B=_v()
_(e8B,b9B)
if(_oz(z,107,l5B,o4B,gg)){b9B.wxVkey=1
var oBC=_n('view')
var fCC=_n('view')
_rz(z,fCC,'class',108,l5B,o4B,gg)
var cDC=_oz(z,109,l5B,o4B,gg)
_(fCC,cDC)
_(oBC,fCC)
var hEC=_n('view')
_rz(z,hEC,'class',110,l5B,o4B,gg)
var oFC=_oz(z,111,l5B,o4B,gg)
_(hEC,oFC)
_(oBC,hEC)
var cGC=_n('view')
_rz(z,cGC,'class',112,l5B,o4B,gg)
var oHC=_oz(z,113,l5B,o4B,gg)
_(cGC,oHC)
_(oBC,cGC)
_(b9B,oBC)
}
var o0B=_v()
_(e8B,o0B)
if(_oz(z,114,l5B,o4B,gg)){o0B.wxVkey=1
var lIC=_n('view')
var aJC=_mz(z,'view',['class',115,'style',1],[],l5B,o4B,gg)
var eLC=_oz(z,117,l5B,o4B,gg)
_(aJC,eLC)
var tKC=_v()
_(aJC,tKC)
if(_oz(z,118,l5B,o4B,gg)){tKC.wxVkey=1
var bMC=_n('text')
var oNC=_oz(z,119,l5B,o4B,gg)
_(bMC,oNC)
_(tKC,bMC)
}
tKC.wxXCkey=1
...
var xAC=_v()
_(e8B,xAC)
if(_oz(z,120,l5B,o4B,gg)){xAC.wxVkey=1
var xOC=_n('view')
var oPC=_n('view')
_rz(z,oPC,'class',121,l5B,o4B,gg)
var fQC=_oz(z,122,l5B,o4B,gg)
_(oPC,fQC)
_(xOC,oPC)
var cRC=_n('view')
_rz(z,cRC,'class',123,l5B,o4B,gg)
var hSC=_oz(z,124,l5B,o4B,gg)
_(cRC,hSC)
_(xOC,cRC)
var oTC=_n('view')
_rz(z,oTC,'class',125,l5B,o4B,gg)
var cUC=_oz(z,126,l5B,o4B,gg)
_(oTC,cUC)
_(xOC,oTC)
var oVC=_n('view')
_rz(z,oVC,'class',127,l5B,o4B,gg)
var lWC=_oz(z,128,l5B,o4B,gg)
_(oVC,lWC)
_(xOC,oVC)
var aXC=_n('view')
_rz(z,aXC,'class',129,l5B,o4B,gg)
var tYC=_oz(z,130,l5B,o4B,gg)
_(aXC,tYC)
_(xOC,aXC)
_(xAC,xOC)
}
...
o2B.wxXCkey=2
_2z(z,102,c3B,e,s,gg,o2B,'item','index','index')
_(oXB,fYB)
_(xC,oXB)
}
var oD=_v()
_(oB,oD)
if(_oz(z,131,e,s,gg)){oD.wxVkey=1
var eZC=_mz(z,'view',['bindtap',132,'catchtouchmove',1,'class',2,'data-event-opts',3],[],e,s,gg)
var b1C=_n('view')
_rz(z,b1C,'class',136,e,s,gg)
var o2C=_n('view')
_rz(z,o2C,'class',137,e,s,gg)
var x3C=_mz(z,'canvas',['bindtouchstart',138,'canvasId',1,'class',2,'data-event-opts',3,'id',4],[],e,s,gg)
_(o2C,x3C)
_(b1C,o2C)
_(eZC,b1C)
_(oD,eZC)
